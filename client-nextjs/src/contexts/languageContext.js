...
const translations = {
  ko: {
    ...
    marketing: {
        ...
        marketAnalysis: "시장 및 경쟁 분석",
        campaignCalendar: "캠페인 캘린더",
        contentLibrary: "콘텐츠 라이브러리",
        influencerManagement: "인플루언서 관리",
        budgetExpense: "예산·지출 관리",
        settings: "설정",
    },
    accounting: '회계 관리',
 ...
 'sidebar.menuTitle': '메뉴',
  ...
  vi: {
    ...
    marketing: {
        dashboard: "Bảng điều khiển Marketing",
        content: "Quản lý Nội dung",
        monitoring: "Giám sát",
        insights: "Thông tin chi tiết",
        abtest: "Kiểm tra A/B",
        trends: "Phân tích Xu hướng",
        engagement: "Quản lý Tương tác",
        brandStrategy: "Chiến lược Thương hiệu",
        marketAnalysis: "Phân tích Thị trường & Đối thủ",
        campaignCalendar: "Lịch Chiến dịch",
        contentLibrary: "Thư viện Nội dung",
        influencerManagement: "Quản lý Influencer",
        budgetExpense: "Ngân sách & Chi phí",
        settings: "Cài đặt",
    },
 ...
 'sidebar.menuTitle': 'Menu',
  ...
  en: {
    ...
    marketing: {
        ...
        marketAnalysis: "Market & Competitor Analysis",
