...
const translations = {
 ...
 'sidebar.menuTitle': '메뉴',
    ...
    // 추가 번역 - 공통
    'common.loading': '로딩 중...',
    'common.error.title': '오류',
    'common.success.title': '성공',
    'common.confirm': '확인',
    'common.close': '닫기',
    'common.delete': '삭제',
    'common.update': '업데이트',
    ...
    'common.notes': '메모',
    'common.comments': '댓글',
    'common.attachments': '첨부파일',
    'common.tags': '태그',
    'common.keywords': '키워드',
    'common.options': '옵션',
    'common.settings': '설정',
    'common.configuration': '구성',
    ...
    'header.settings': '설정',
    'header.logout': '로그아웃',
    'header.search.placeholder': '검색...',
    'header.menu': '메뉴',
    'header.toggle.sidebar': '사이드바 토글',
    'header.toggle.theme': '테마 변경',
    'header.toggle.language': '언어 변경',
    ...
    'form.required': '필수 항목',
    'form.optional': '선택 항목',
    'form.invalid': '유효하지 않음',
    'form.valid': '유효함',
    'form.saved': '저장됨',
    'form.saved.description': '변경사항이 저장되었습니다',
    'form.unsaved': '저장되지 않음',
    'form.unsaved.description': '저장되지 않은 변경사항이 있습니다',
    'form.validation.required': '이 필드는 필수입니다',
    'form.validation.email': '유효한 이메일 주소를 입력하세요',
    'form.validation.minLength': '최소 {min}자 이상 입력하세요',
    'form.validation.maxLength': '최대 {max}자까지 입력 가능합니다',
    'form.validation.pattern': '올바른 형식으로 입력하세요',
    'form.validation.number': '숫자만 입력하세요',
    'form.validation.positive': '양수만 입력하세요',
    'form.validation.date': '유효한 날짜를 입력하세요',
    'form.validation.phone': '유효한 전화번호를 입력하세요',
    'form.validation.url': '유효한 URL을 입력하세요',
    ...
    'table.pagination.of': ' / ',
    'table.pagination.first': '첫 페이지',
    'table.pagination.last': '마지막 페이지',
    ...
    'modal.update': '업데이트',
    'modal.loading': '처리 중...',
    'modal.error': '오류가 발생했습니다',
    'modal.success': '성공적으로 처리되었습니다',

    // 알림 관련 번역
    'notification.success': '성공',
    'notification.error': '오류',
    'notification.warning': '경고',
    'notification.info': '정보',
    'notification.close': '닫기',
    'notification.dismiss': '무시',
    'notification.markAsRead': '읽음으로 표시',
    'notification.markAllAsRead': '모두 읽음으로 표시',
    'notification.viewAll': '모든 알림 보기',
    'notification.noNotifications': '새로운 알림이 없습니다',

    // 파일 업로드 관련 번역
    'upload.dropZone': '파일을 여기에 드래그하거나 클릭하여 선택하세요',
    'upload.selectFiles': '파일 선택',
    'upload.uploading': '업로드 중...',
    'upload.success': '업로드 완료',
    'upload.error': '업로드 실패',
    'upload.maxSize': '최대 파일 크기: {size}',
    'upload.allowedTypes': '허용된 파일 형식: {types}',
    'upload.remove': '제거',
    'upload.retry': '다시 시도',
    'upload.cancel': '취소',
    ...
    'settings.accessControl': '접근 제어 / 권한 관리',
    'settings.general': '일반 설정',
    'settings.profile': '프로필 설정',
    'settings.notifications': '알림 설정',
    'settings.integrations': '연동 설정',
    'settings.workflows': '워크플로우·템플릿 관리',
    'settings.dataManagement': '데이터 관리',
    'settings.auditLogs': '감사 로그',
    'settings.billing': '과금·라이선스 관리',

    // 접근 제어 / 권한 관리
    'accessControl.title': '접근 제어 / 권한 관리',
    'accessControl.description': '역할 기반 접근 제어(RBAC) 및 권한 매트릭스 관리',
    'accessControl.roleManagement': '역할 관리',
    'accessControl.permissionMatrix': '권한 매트릭스',
    'accessControl.userRoleAssignment': '사용자·그룹별 역할 할당',
    'accessControl.changeHistory': '권한 변경 이력',
    'accessControl.roles.superAdmin': '슈퍼어드민',
    'accessControl.roles.admin': '어드민',
    'accessControl.roles.manager': '매니저',
    'accessControl.roles.editor': '에디터',
    'accessControl.roles.guest': '게스트',
    'accessControl.permissions.read': '읽기',
    'accessControl.permissions.write': '쓰기',
    'accessControl.permissions.delete': '삭제',
    'accessControl.permissions.approve': '승인',

    // 일반 설정
    'general.title': '일반 설정',
    'general.description': '애플리케이션 기본 설정 관리',
    'general.appName': '애플리케이션 이름',
    'general.logo': '로고',
    'general.theme': '테마 설정',
    'general.themeColor': '테마 색상',
    'general.font': '폰트',
    'general.timezone': '타임존',
    'general.locale': '언어 및 로케일',
    'general.dateFormat': '날짜 형식',

    // 프로필 설정
    'profileSettings.title': '프로필 설정',
    'profileSettings.description': '개인 계정 및 보안 설정',
    'profileSettings.changePassword': '비밀번호 변경',
    'profileSettings.twoFactorAuth': '2단계 인증',
    'profileSettings.currentPassword': '현재 비밀번호',
    'profileSettings.newPassword': '새 비밀번호',
    'profileSettings.confirmPassword': '비밀번호 확인',

    // 알림 설정
    'notifications.title': '알림 설정',
    'notifications.description': '이메일, SMS, 푸시 알림 설정 관리',
    'notifications.channels': '알림 채널',
    'notifications.templates': '알림 템플릿',
    'notifications.events': '이벤트별 설정',
    ...
    'integrations.description': '외부 서비스 및 API 연동 관리',
    'integrations.apiKeys': 'API 키 관리',
    'integrations.oauth': 'OAuth 설정',
    'integrations.aiModels': 'AI 모델 연동',
    'integrations.webhooks': 'Webhook 설정',
    'integrations.openai': 'OpenAI',
    'integrations.gemini': 'Google Gemini',

    // 워크플로우·템플릿 관리
    'workflows.title': '워크플로우·템플릿 관리',
    'workflows.description': '문서 템플릿 및 승인 프로세스 관리',
    'workflows.templates': '문서 템플릿',
    'workflows.approvalFlow': '승인 라인',
    'workflows.versionControl': '버전 관리',
    'workflows.deployment': '배포',

    // 데이터 관리
    'dataManagement.title': '데이터 관리',
    'dataManagement.description': '데이터 업로드, 백업 및 정합성 관리',
    'dataManagement.bulkUpload': '대량 업로드',
    'dataManagement.dataValidation': '데이터 정합성 검사',
    'dataManagement.backup': '백업 관리',
    'dataManagement.scheduler': '스케줄러',

    // 감사 로그
    'auditLogs.title': '감사 로그',
    'auditLogs.description': '시스템 접근 및 변경 이력 조회',
    'auditLogs.loginHistory': '로그인 이력',
    'auditLogs.permissionChanges': '권한 변경 이력',
    'auditLogs.crudHistory': 'CRUD 이력',
    'auditLogs.export': '로그 내보내기',

    // 과금·라이선스 관리
    'billing.title': '과금·라이선스 관리',
    'billing.description': '사용량 기반 과금 및 라이선스 관리',
    'billing.plans': '과금 플랜',
    'billing.usage': '사용량',
    'billing.license': '라이선스',
    'billing.notifications': '만료 알림',
    'status.archived': '보관됨',
    'status.deleted': '삭제됨',
 ...
 'sidebar.menuTitle': 'Menu',
    ...
    'common.error.title': 'Lỗi',
    'common.success.title': 'Thành công',
    ...
    'common.access': 'Truy cập',
    'common.security': 'Bảo mật',
    'common.privacy': 'Riêng tư',
    ...
    'header.menu': 'Menu',
    'header.toggle.sidebar': 'Chuyển đổi thanh bên',
    'header.toggle.theme': 'Thay đổi chủ đề',
    'header.toggle.language': 'Thay đổi ngôn ngữ',
    ...
    'form.valid': 'Hợp lệ',
    'form.saved': 'Đã lưu',
    'form.saved.description': 'Thay đổi đã được lưu',
    'form.unsaved': 'Chưa lưu',
    'form.unsaved.description': 'Có thay đổi chưa được lưu',
    'form.validation.required': 'Trường này là bắt buộc',
    'form.validation.email': 'Vui lòng nhập địa chỉ email hợp lệ',
    'form.validation.minLength': 'Vui lòng nhập ít nhất {min} ký tự',
    'form.validation.maxLength': 'Tối đa {max} ký tự',
    'form.validation.pattern': 'Vui lòng nhập đúng định dạng',
    'form.validation.number': 'Chỉ nhập số',
    'form.validation.positive': 'Chỉ nhập số dương',
    'form.validation.date': 'Vui lòng nhập ngày hợp lệ',
    'form.validation.phone': 'Vui lòng nhập số điện thoại hợp lệ',
    'form.validation.url': 'Vui lòng nhập URL hợp lệ',

    // 테이블 관련 번역
    'table.noData': 'Không có dữ liệu',
    'table.loading': 'Đang tải dữ liệu...',
    'table.error': 'Lỗi khi tải dữ liệu',
    'table.pagination.showing': 'Hiển thị {start}-{end} trong tổng số {total}',
    'table.pagination.page': 'Trang',
    'table.pagination.of': ' / ',
    'table.pagination.first': 'Trang đầu',
    'table.pagination.last': 'Trang cuối',
    'table.pagination.next': 'Trang sau',
    'table.pagination.prev': 'Trang trước',    'table.sort.asc': 'Tăng dần',
    'table.sort.desc': 'Giảm dần',
    'table.actions': 'Hành động',
    'table.select.all': 'Chọn tất cả',
    'table.select.none': 'Bỏ chọn',
    'table.export': 'Xuất',
    'table.filter': 'Lọc',
    'table.search': 'Tìm kiếm',
    'table.columns': 'Cột',
    'table.density': 'Mật độ',
    'table.fullscreen': 'Toàn màn hình',
    ...
    'modal.success': 'Xử lý thành công',
    ...
    'notification.noNotifications': 'Không có thông báo mới',

    // 파일 업로드 관련 번역
    'upload.dropZone': 'Kéo thả tệp vào đây hoặc nhấp để chọn',
    'upload.selectFiles': 'Chọn tệp',
    'upload.uploading': 'Đang tải lên...',
    'upload.success': 'Tải lên thành công',
    'upload.error': 'Tải lên thất bại',
    'upload.maxSize': 'Kích thước tệp tối đa: {size}',
    'upload.allowedTypes': 'Định dạng cho phép: {types}',
    'upload.remove': 'Xóa',
    ...
    'date.nextWeek': 'Tuần sau',
    'date.thisMonth': 'Tháng này',
    'date.lastMonth': 'Tháng trước',
    'date.nextMonth': 'Tháng sau',
    'date.thisYear': 'Năm nay',
    'date.lastYear': 'Năm trước',
    'date.nextYear': 'Năm sau',
    'date.now': 'Bây giờ',
    'date.ago': 'trước',
    'date.from.now': 'sau',
    'date.format.short': 'DD/MM/YYYY',
    'date.format.long': 'DD tháng MM năm YYYY',
    'date.format.time': 'HH:mm',
    ...
    // Access Control
    'accessControl.title': 'Kiểm soát truy cập / Quản lý quyền',
    'accessControl.description': 'Kiểm soát truy cập dựa trên vai trò (RBAC) và quản lý ma trận quyền',
    'accessControl.roleManagement': 'Quản lý vai trò',
    'accessControl.permissionMatrix': 'Ma trận quyền',
    'accessControl.userRoleAssignment': 'Phân quyền người dùng & nhóm',
    'accessControl.changeHistory': 'Lịch sử thay đổi quyền',
    'accessControl.roles.superAdmin': 'Siêu quản trị viên',
    'accessControl.roles.admin': 'Quản trị viên',
    'accessControl.roles.manager': 'Quản lý',
    'accessControl.roles.editor': 'Biên tập viên',
    'accessControl.roles.guest': 'Khách',
    'accessControl.permissions.read': 'Đọc',
    'accessControl.permissions.write': 'Ghi',
    'accessControl.permissions.delete': 'Xóa',
    'accessControl.permissions.approve': 'Phê duyệt',

    // General Settings
    'general.title': 'Cài đặt chung',
    'general.description': 'Quản lý cài đặt cơ bản của ứng dụng',
    'general.appName': 'Tên ứng dụng',
    'general.logo': 'Logo',
    'general.theme': 'Cài đặt giao diện',
    'general.themeColor': 'Màu giao diện',
    'general.font': 'Phông chữ',
    'general.timezone': 'Múi giờ',
    'general.locale': 'Ngôn ngữ & Locale',
    'general.dateFormat': 'Định dạng ngày',

    // Profile Settings
    'profileSettings.title': 'Cài đặt hồ sơ',
    'profileSettings.description': 'Cài đặt tài khoản cá nhân và bảo mật',
    'profileSettings.changePassword': 'Đổi mật khẩu',
    'profileSettings.twoFactorAuth': 'Xác thực hai yếu tố',
    'profileSettings.currentPassword': 'Mật khẩu hiện tại',
    'profileSettings.newPassword': 'Mật khẩu mới',
    'profileSettings.confirmPassword': 'Xác nhận mật khẩu',

    // Notification Settings
    'notifications.title': 'Cài đặt thông báo',
    'notifications.description': 'Quản lý thông báo email, SMS và push',
    'notifications.channels': 'Kênh thông báo',
    'notifications.templates': 'Mẫu thông báo',
    'notifications.events': 'Cài đặt sự kiện',
    'notifications.email': 'Email',
    'notifications.sms': 'SMS',
    'notifications.push': 'Thông báo đẩy',

    // Integration Settings
    'integrations.title': 'Cài đặt tích hợp',
    'integrations.description': 'Quản lý tích hợp dịch vụ bên ngoài và API',
    'integrations.apiKeys': 'Quản lý API Key',
    'integrations.oauth': 'Cài đặt OAuth',
    'integrations.aiModels': 'Tích hợp mô hình AI',
    'integrations.webhooks': 'Cài đặt Webhook',
    'integrations.openai': 'OpenAI',
    'integrations.gemini': 'Google Gemini',

    // Workflow & Template Management
    'workflows.title': 'Quản lý quy trình & mẫu',
    'workflows.description': 'Quản lý mẫu tài liệu và quy trình phê duyệt',
    'workflows.templates': 'Mẫu tài liệu',
    'workflows.approvalFlow': 'Quy trình phê duyệt',
    'workflows.versionControl': 'Quản lý phiên bản',
    'workflows.deployment': 'Triển khai',

    // Data Management
    'dataManagement.title': 'Quản lý dữ liệu',
    'dataManagement.description': 'Tải lên dữ liệu, sao lưu và quản lý tính toàn vẹn',
    'dataManagement.bulkUpload': 'Tải lên hàng loạt',
    'dataManagement.dataValidation': 'Kiểm tra tính toàn vẹn dữ liệu',
    'dataManagement.backup': 'Quản lý sao lưu',
    'dataManagement.scheduler': 'Bộ lập lịch',

    // Audit Logs
    'auditLogs.title': 'Nhật ký kiểm toán',
    'auditLogs.description': 'Lịch sử truy cập và thay đổi hệ thống',
    'auditLogs.loginHistory': 'Lịch sử đăng nhập',
    'auditLogs.permissionChanges': 'Thay đổi quyền',
    'auditLogs.crudHistory': 'Lịch sử CRUD',
    'auditLogs.export': 'Xuất nhật ký',

    // Billing & License Management
    'billing.title': 'Quản lý thanh toán & giấy phép',
    'billing.description': 'Thanh toán theo sử dụng và quản lý giấy phép',
    'billing.plans': 'Gói thanh toán',
    'billing.usage': 'Sử dụng',
    'billing.license': 'Giấy phép',
    'billing.notifications': 'Thông báo hết hạn',
 ...
 'sidebar.menuTitle': 'Menu',
    ...
    'header.menu': 'Menu',
    'header.toggle.sidebar': 'Toggle Sidebar',
    ...
    'form.valid': 'Valid',
    'form.saved': 'Saved',
    'form.saved.description': 'Changes have been saved',
    'form.unsaved': 'Unsaved',
    'form.unsaved.description': 'You have unsaved changes',
    'form.validation.required': 'This field is required',
    'form.validation.email': 'Please enter a valid email address',
    'form.validation.minLength': 'Please enter at least {min} characters',
    'form.validation.maxLength': 'Maximum {max} characters allowed',
    'form.validation.pattern': 'Please enter in correct format',
    'form.validation.number': 'Please enter numbers only',
    'form.validation.positive': 'Please enter positive numbers only',
    ...
    'modal.success': 'Successfully processed',
    ...
    'date.nextMonth': 'Next Month',    'date.thisYear': 'This Year',
    'date.lastYear': 'Last Year',
    'date.nextYear': 'Next Year',
    'date.now': 'Now',
    'date.ago': 'ago',
    'date.from.now': 'from now',
    'date.format.short': 'MM/DD/YYYY',
    'date.format.long': 'MMMM DD, YYYY',
    'date.format.time': 'HH:mm',
    'date.format.datetime': 'MM/DD/YYYY HH:mm',
    ...
    // Access Control
    'accessControl.title': 'Access Control / Permission Management',
    'accessControl.description': 'Role-based access control (RBAC) and permission matrix management',
    'accessControl.roleManagement': 'Role Management',
    'accessControl.permissionMatrix': 'Permission Matrix',
    'accessControl.userRoleAssignment': 'User & Group Role Assignment',
    'accessControl.changeHistory': 'Permission Change History',
    'accessControl.roles.superAdmin': 'Super Admin',
    'accessControl.roles.admin': 'Admin',
    'accessControl.roles.manager': 'Manager',
    'accessControl.roles.editor': 'Editor',
    'accessControl.roles.guest': 'Guest',
    'accessControl.permissions.read': 'Read',
    'accessControl.permissions.write': 'Write',
    'accessControl.permissions.delete': 'Delete',
    'accessControl.permissions.approve': 'Approve',

    // General Settings
    'general.title': 'General Settings',
    'general.description': 'Application basic settings management',
    'general.appName': 'Application Name',
    'general.logo': 'Logo',
    'general.theme': 'Theme Settings',
    'general.themeColor': 'Theme Color',
    'general.font': 'Font',
    'general.timezone': 'Timezone',
    'general.locale': 'Language & Locale',
    'general.dateFormat': 'Date Format',

    // Profile Settings
    'profileSettings.title': 'Profile Settings',
    'profileSettings.description': 'Personal account and security settings',
    'profileSettings.changePassword': 'Change Password',
    'profileSettings.twoFactorAuth': 'Two-Factor Authentication',
    'profileSettings.currentPassword': 'Current Password',
    'profileSettings.newPassword': 'New Password',
    'profileSettings.confirmPassword': 'Confirm Password',

    // Notification Settings
    'notifications.title': 'Notification Settings',
    'notifications.description': 'Email, SMS, and push notification management',
    'notifications.channels': 'Notification Channels',
    'notifications.templates': 'Notification Templates',
    'notifications.events': 'Event Settings',
    'notifications.email': 'Email',
    'notifications.sms': 'SMS',
    ...
    'integrations.description': 'External service and API integration management',
    'integrations.apiKeys': 'API Key Management',
    'integrations.oauth': 'OAuth Settings',
    'integrations.aiModels': 'AI Model Integration',
    'integrations.webhooks': 'Webhook Settings',
    'integrations.openai': 'OpenAI',
    'integrations.gemini': 'Google Gemini',

    // Workflow & Template Management
    'workflows.title': 'Workflow & Template Management',
    'workflows.description': 'Document template and approval process management',
    'workflows.templates': 'Document Templates',
    'workflows.approvalFlow': 'Approval Flow',
    'workflows.versionControl': 'Version Control',
    'workflows.deployment': 'Deployment',

    // Data Management
    'dataManagement.title': 'Data Management',
    'dataManagement.description': 'Data upload, backup and integrity management',
    'dataManagement.bulkUpload': 'Bulk Upload',
    'dataManagement.dataValidation': 'Data Validation',
    'dataManagement.backup': 'Backup Management',
    'dataManagement.scheduler': 'Scheduler',

    // Audit Logs
    'auditLogs.title': 'Audit Logs',
    'auditLogs.description': 'System access and change history',
    'auditLogs.loginHistory': 'Login History',
    'auditLogs.permissionChanges': 'Permission Changes',
    'auditLogs.crudHistory': 'CRUD History',
    'auditLogs.export': 'Export Logs',

    // Billing & License Management
    'billing.title': 'Billing & License Management',
    'billing.description': 'Usage-based billing and license management',
    'billing.plans': 'Billing Plans',
    'billing.usage': 'Usage',
    'billing.license': 'License',
    'billing.notifications': 'Expiry Notifications',
