...
const translations = {
  ko: {
    ...
    "accounting.dashboard.description":
      "전체 회계 현황을 한눈에 확인하고 관리하세요",
    ...
    "accounting.quickActionsDescription":
      "자주 사용하는 회계 기능에 빠르게 접근하세요",
    ...
    "register.skills.placeholder":
      "예: React, Next.js, Node.js, Photoshop, sales 등",
    ...
    "dashboard.opportunities.description":
      "현재 진행 중인 주요 영업기회입니다.",
    ...
    "customer.imageGalleryDescription":
      "고객사의 프로필 이미지와 시설 사진을 확인하고 관리할 수 있습니다",
    "customer.contactPersons": "담당자 정보",
    "customer.contactPersonsDescription":
  ...
  vi: {
    ...
    "accounting.dashboard.description":
      "Xem tổng quan tình hình kế toán trong một cái nhìn",
    ...
    "accounting.setup.description":
      "Thiết lập thông tin kế toán cơ bản theo chuẩn kế toán Việt Nam",
    ...
    "sales.dashboard.description":
      "Kiểm tra quy trình bán hàng và các chỉ số hiệu suất trong một cái nhìn",
    ...
    "sales.quickActionsDescription":
      "Truy cập nhanh các tính năng bán hàng thường dùng",
    ...
    "accounting.quickActionsDescription":
      "Truy cập nhanh các tính năng kế toán thường dùng",
    "accounting.pendingTasksDescription": "Các mục cần phê duyệt hoặc xử lý",
    "accounting.recentTransactionsDescription":
      "Kiểm tra các giao dịch kế toán gần đây",
    ...
    "sales.person.description":
      "Chọn nhân viên kinh doanh phụ trách khách hàng này",
    "sales.person.placeholder": "Tìm kiếm và chọn nhân viên kinh doanh",

    // 이미지 관련 번역
    "image.registration": "Đăng ký hình ảnh",
    "image.description":
      "Đăng ký ảnh đại diện và ảnh cơ sở vật chất của khách hàng",
    ...
    "login.description":
      "Đăng nhập vào tài khoản của bạn để sử dụng hệ thống CRM.",
    "login.email": "Email",
    ...
    "register.address.placeholder":
      "Ví dụ: 118 Huỳnh Tấn Phát, Tân Thuận Tây, Quận 7, Hồ Chí Minh",
    ...
    "register.skills.placeholder":
      "Ví dụ: React, Next.js, Node.js, Photoshop, sales, v.v",
    ...
    "dashboard.description":
      "Xem tổng quan tình hình kinh doanh trong một cái nhìn.",
    ...
    "dashboard.recentCustomers.description":
      "Danh sách khách hàng đăng ký gần đây.",
    "dashboard.opportunities": "Cơ hội đang tiến hành",
    "dashboard.opportunities.description":
      "Các cơ hội bán hàng chính đang tiến hành.",
    ...
    "customers.description":
      "Quản lý và phân tích thông tin khách hàng hiệu quả",
    "customers.addNew": "Thêm khách hàng mới",
    "customers.total": "Tổng khách hàng",
    ...
    "customers.searchPlaceholder":
      "Tìm kiếm theo tên công ty hoặc người phụ trách...",

    // 고객 상세페이지 번역
    "customer.basicInfo": "Thông tin công ty cơ bản",
    "customer.basicInfoDescription":
      "Xem và chỉnh sửa thông tin cơ bản của khách hàng",
    ...
    "customer.contactInfoDescription":
      "Quản lý thông tin liên hệ của khách hàng",
    "customer.imageGallery": "Thư viện hình ảnh",
    "customer.imageGalleryDescription":
      "Xem và quản lý hình ảnh hồ sơ và cơ sở vật chất của khách hàng",
    "customer.contactPersons": "Thông tin người liên hệ",
    "customer.contactPersonsDescription":
      "Quản lý thông tin chi tiết của các người liên hệ",
    ...
    "table.pagination.prev": "Trang trước",
    "table.sort.asc": "Tăng dần",
    ...
    "accessControl.description":
      "Kiểm soát truy cập dựa trên vai trò (RBAC) và quản lý ma trận quyền",
    ...
    "dataManagement.description":
      "Tải lên dữ liệu, sao lưu và quản lý tính toàn vẹn",
  ...
  en: {
    ...
    "accounting.dashboard.description":
      "Get an overview of your entire accounting status at a glance",
    ...
    "accounting.setup.description":
      "Set up basic accounting information according to Vietnamese accounting standards",
    ...
    "sales.dashboard.description":
      "Get an overview of your sales pipeline and performance metrics at a glance",
    ...
    "sales.quickActionsDescription":
      "Quickly access frequently used sales features",
    ...
    "accounting.quickActionsDescription":
      "Quickly access frequently used accounting features",
    "accounting.pendingTasksDescription":
      "Items that require approval or processing",
    "accounting.recentTransactionsDescription":
      "Check recent accounting transactions",
    ...
    "customer.add.description":
      "Enter customer information and contact information",
    ...
    "sales.person.description":
      "Select the sales representative for this customer",
    "sales.person.placeholder": "Search and select a sales representative",

    // 이미지 관련 번역
    "image.registration": "Image Registration",
    "image.description":
      "Register the customer profile image and facility photos",
    ...
    "register.description":
      "Create a new account to get started with CRM system.",
    ...
    "register.skills.placeholder":
      "e.g. React, Next.js, Node.js, Photoshop, sales, etc",
    ...
    "dashboard.description":
      "Get an overview of your entire business at a glance.",
    ...
    "dashboard.recentCustomers.description":
      "List of recently registered customers.",
    "dashboard.opportunities": "Ongoing Opportunities",
    "dashboard.opportunities.description":
      "Major sales opportunities currently in progress.",
    ...
    "customers.description":
      "Efficiently manage and analyze customer information",
    "customers.addNew": "Add New Customer",
    "customers.total": "Total Customers",
    ...
    "customer.basicInfoDescription":
      "You can check and modify the customer's basic information",
    ...
    "customer.contactInfoDescription":
      "Manage the customer's contact information",
    "customer.imageGallery": "Image Gallery",
    "customer.imageGalleryDescription":
      "You can check and manage the customer's profile image and facility photos",
    "customer.contactPersons": "Contact Persons Information",
    "customer.contactPersonsDescription":
      "Manage the detailed information of the customer's contact persons",
    ...
    "accessControl.description":
      "Role-based access control (RBAC) and permission matrix management",
    ...
    "integrations.description":
      "External service and API integration management",
    ...
    "workflows.description":
      "Document template and approval process management",
    ...
    "dataManagement.description":
      "Data upload, backup and integrity management",
