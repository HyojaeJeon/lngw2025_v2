                ...
                {filteredEmployees.map((employee) => (
                  <div
                    ...
                    className={`p-4 border-b cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 ${
                      selectedEmployee?.id === employee.id ? 'bg-blue-50 dark:bg-blue-900' : ''
                    }`}
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm">{selectedEmployee.department} / {selectedEmployee.position}</p>
                    </div>
                    <div>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-4">
                  ...
                  <Input id="address" placeholder="Ho Chi Minh City, District 1" />
                </div>
              </div>
