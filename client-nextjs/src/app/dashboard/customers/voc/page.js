...
export default function VOCPage() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case "완료": return "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300";
      case "처리중": return "bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300";
      case "대기": return "bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300";
  ...
  const getPriorityColor = (priority) => {
    switch (priority) {
      case "높음": return "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300";
      case "보통": return "bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300";
      case "낮음": return "bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300";
      default: return "bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300";
    }
  };
  ...
  const filteredVOC = vocData.filter(item =>
          ...
          <Card className="text-center py-12">
            <CardContent>
              <svg className="w-16 h-16 mx-auto text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 20a7.962 7.962 0 01-5.657-2.343l-1.04 1.04A9.938 9.938 0 0012 22a9.938 9.938 0 007.697-2.303l-1.04-1.04z" />
              </svg>
