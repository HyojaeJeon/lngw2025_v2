  ...
  const historyData = [
    {
      ...
      title: "프로젝트 킥오프 미팅",
      description:
        "새로운 ERP 시스템 구축 프로젝트 시작을 위한 킥오프 미팅을 진행했습니다.",
      date: "2024-01-15",
      time: "14:00",
      duration: "2시간",
    ...
    },
    {
      ...
      description:
        "생산 관리 시스템에서 발생한 오류에 대한 긴급 지원 요청 통화",
      date: "2024-01-14",
      time: "16:30",
      duration: "30분",
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-medium ${getResultColor(item.result)}`}
                      >
                        {item.result}
                      </span>
                    </div>
