...
const CategoryForm = ({ category, onSave, onCancel, isOpen, categories }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const categoryData = {
      ...
      createdAt: category ? category.createdAt : new Date().toISOString().split('T')[0]
    };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-2">카테고리 코드 *</label>
            <Input
              value={formData.code}
          ...
          <div>
            <label className="block text-sm font-medium mb-2">상위 카테고리</label>
            <select
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-2">베트남어 이름</label>
              <Input
            ...
            <div>
              <label className="block text-sm font-medium mb-2">영어 이름</label>
              <Input
          ...
          <div className="grid grid-cols-1 gap-4">
            <div>
              <label className="block text-sm font-medium mb-2">한국어 설명</label>
              <textarea
            ...
            <div>
              <label className="block text-sm font-medium mb-2">베트남어 설명</label>
              <textarea
            ...
            <div>
              <label className="block text-sm font-medium mb-2">영어 설명</label>
              <textarea
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center space-x-2 pt-6">
              <input
                ...
                className="rounded"
              />
              <label htmlFor="isActive" className="text-sm font-medium">활성</label>
            </div>
          </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <div className="text-sm font-medium text-gray-500 dark:text-gray-400">총 카테고리</div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <div className="text-sm font-medium text-gray-500 dark:text-gray-400">활성 카테고리</div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <div className="text-sm font-medium text-gray-500 dark:text-gray-400">1단계 카테고리</div>
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <div className="text-sm font-medium text-gray-500 dark:text-gray-400">2단계 카테고리</div>
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">
