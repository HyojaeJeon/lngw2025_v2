...
const seedData = async () => {
  try {
    ...
    await models.TrendingKeyword.bulkCreate([
      { keyword: '#여행', mentions: 12500, growth: 15.5, sentiment: 'positive', period: '24h' },
      { keyword: '#뷰티', mentions: 9800, growth: 8.2, sentiment: 'positive', period: '24h' },
      { keyword: '#음식', mentions: 8400, growth: -2.1, sentiment: 'neutral', period: '24h' },
      { keyword: '#패션', mentions: 6200, growth: 12.8, sentiment: 'positive', period: '24h' },
      { keyword: '#건강', mentions: 5800, growth: 22.3, sentiment: 'positive', period: '24h' },
      { keyword: '#운동', mentions: 4900, growth: 18.7, sentiment: 'positive', period: '24h' },
      { keyword: '#영화', mentions: 4200, growth: -5.4, sentiment: 'neutral', period: '24h' },
      { keyword: '#책', mentions: 3800, growth: 3.2, sentiment: 'positive', period: '24h' },
      { keyword: '#카페', mentions: 3500, growth: 7.1, sentiment: 'positive', period: '24h' },
      { keyword: '#반려동물', mentions: 3100, growth: 25.6, sentiment: 'positive', period: '24h' }
    ]);
    ...
    await models.Content.bulkCreate([
      {
        ...
        content: '여름 휴가를 계획하고 계신가요? 이 가이드로 완벽한 휴가를 준비하세요!',
        mediaType: 'text',
        mode: 'Manual',
        keywords: '#여행, #휴가, #여름',
        status: 'approved',
